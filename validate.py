...
from base import LANG_DIR_FULL, LANG_DIR_VALID
...
# 修改语言文件
with open(LANG_DIR_FULL / "zh_cn.json", "r", encoding="utf-8") as f:
    data: Dict[str, str] = json.load(f)
edited_data: Dict[str, str] = {k: v for k, v in data.items() if is_valid_key(k)}
with open(LANG_DIR_VALID / "zh_cn.json", "w", encoding="utf-8") as f:
